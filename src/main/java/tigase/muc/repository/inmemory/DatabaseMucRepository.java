 ...
 * 
 */
public class DatabaseMucRepository implements IMucRepository {
	...
	public DatabaseMucRepository(final MucContext mucConfig, final MucDAO dao) throws RepositoryException {
		this.dao = dao;
